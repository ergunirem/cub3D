...
/*   Updated: 2021/03/08 17:20:36 by icikrikc      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	look_left(t_window *window)
{
	...
	p->dir_y = dir_x * sin(-p->rotate_speed) + p->dir_y * cos(-p->rotate_speed);
	p->plane_x = p->plane_x * cos(-p->rotate_speed) - p->plane_y * sin(-p->rotate_speed);
	p->plane_y = plane_x * sin(-p->rotate_speed) + p->plane_y * cos(-p->rotate_speed);
}
